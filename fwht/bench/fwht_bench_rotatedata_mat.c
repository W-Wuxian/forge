...
// 2^10
BENCH_ROTATEDATA_MAT(JUBE_NROWS, JUBE_NCOLS, 0, 1)
BENCH_ROTATEDATA_MAT_RMAJ(JUBE_NROWS, JUBE_NCOLS, 0, 1)
BENCH_ROTATEDATA_MAT(JUBE_NROWS, JUBE_NCOLS, 0, 100)
BENCH_ROTATEDATA_MAT_RMAJ(JUBE_NROWS, JUBE_NCOLS, 0, 100)
BENCH_ROTATEDATA_MAT(JUBE_NROWS, JUBE_NCOLS, 0, 500)
BENCH_ROTATEDATA_MAT_RMAJ(JUBE_NROWS, JUBE_NCOLS, 0, 500)
BENCH_ROTATEDATA_MAT(JUBE_NROWS, JUBE_NCOLS, 0, 1023)
BENCH_ROTATEDATA_MAT_RMAJ(JUBE_NROWS, JUBE_NCOLS, 0, 1023)
